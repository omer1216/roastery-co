...
export const MENU_ITEMS = [
  ...
  { id: "karak-chai", name: "Karak Chai", description: "Densely spiced, extra-strong milk tea, boiled down for a bold cup", category: "tea", price: 500, temperature: "hot", popular: true, image_url: "/images/menu/karak-chai.jpg", available: true, customizations: { sizes: ["S", "M", "L"], sweetness: ["none", "light", "regular", "extra"] } },
